...
func _ready():
	...
	$HSlider.value = GameSettings.graphics[config_section][config_key]
	$HSlider.min_value = min_value
	$HSlider.max_value = max_value
	$HSlider.step = step
	$HSlider.rounded = rounded
	$LineEdit.text = str(GameSettings.graphics[config_section][config_key])
...
func _on_h_slider_value_changed(value):
	...
	GameSettings.graphics[config_section][config_key] = $HSlider.value
